...
import { useUpdateServicesMutation, TBusinessService } from "@/store/features/business/business.api";

interface EditServiceModalProps {
  isOpen: boolean;
  setIsOpen: (open: boolean) => void;
  service: TBusinessService | null | undefined;
...
const EditServiceModal: React.FC<EditServiceModalProps> = ({
  ...
  const { register, handleSubmit, reset } = useForm<TEditServiceForm>({
    defaultValues: {
      name: "",
      description: "",
      price: "",
  ...
  const [updateService, { isLoading }] = useUpdateServicesMutation();
  ...
  const onSubmit = async (values: TEditServiceForm) => {
      ...
      <DialogPortal>
        ...
        <div className="px-6 py-4 space-y-5">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              />
              <div
                className="w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all bg-white border-gray-300 group-hover:border-gray-500 peer-checked:bg-gray-900 peer-checked:border-gray-900"
              >
                <svg
                  width="11"
                  height="9"
