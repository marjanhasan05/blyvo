...
const CreateAgent = () => {
  ...
  const [isSelectAgentCreationModalOpen, setIsSelectAgentCreationModalOpen] =
    useState(false);
        ...
        {step > 1 &&
          (isManualFlow ? (
            ...
            <>
              ...
              {step === 4 && <ResumeOnboarding onContinue={() => setStep(2)} />}
